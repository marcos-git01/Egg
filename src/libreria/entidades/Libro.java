...
public class Libro implements Serializable {
    ...
    public String toString() {
        return "Libro [" + "Id: " + id + ", ISBN: " + isbn + ", Titulo: " + titulo + ", Año: " + anio + ", Ejemplares totales: " + ejemplares + ", Ejemplares prestados: " + ejemplaresPrestados + ", Ejemplares Restantes: " + ejemplaresRestantes + ", Alta: " + alta + ", Autor: " + autor + ", Editorial: " + editorial + ']';
    }
